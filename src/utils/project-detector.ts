...
export class ProjectDetector {
   ...
   */
  static detectProject(startPath: string = process.cwd()): ProjectInfo {
    ...
    const srcDirs = this.findSourceDirectories(projectRoot);
    const suggestedRoot = this.suggestRootDirectory(projectRoot, srcDirs);
   ...
   */
  private static findSourceDirectories(projectRoot: string): string[] {
   ...
   */
  private static suggestRootDirectory(projectRoot: string, srcDirs: string[]): string {
   ...
   */
  static loadGitignorePatterns(projectRoot: string): string[] {
